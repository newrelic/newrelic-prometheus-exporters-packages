...
All native packages create will be available for instalation in New Relic's public repositories.

## Installation

To use the packages generated by this project you will need to:

- determine your Operating System version
  - Debian, RHEL, CentOS, Amazon Linux:
